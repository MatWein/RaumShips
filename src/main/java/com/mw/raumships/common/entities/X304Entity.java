...
public class X304Entity extends RaumShipsEntity {
    public static final int ID = 1008;
    public static final String NAME = "X304";

    public static final ResourceLocation MODEL = new ResourceLocation(MODID, "models/entity/x304.obj");
    ...
    public X304Entity(World worldIn) {
        super(worldIn);
